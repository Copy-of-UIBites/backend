from authentication.models import PemilikKantin, UserInformation
from rest_framework.viewsets import ReadOnlyModelViewSet
from commons.exceptions import ExtendedAPIException, IntegrityErrorException
...
class RegisterKantinView(APIView):
    permissions = [IsAuthenticated, IsCanteenOwner]
