...
from .views import MyKantinView, UserInformationIdView, UserInformationView,UserRegistrationEmailView, UserEditView

urlpatterns = [
    path('profile', UserInformationView.as_view(), name='information'),
    path('profile/<int:id>', UserInformationIdView.as_view(), name='information_id'),
